...
int carsale_category = Integer.parseInt(request.getParameter("model"));
	...
	CarSizeBean sbean = sdao.getReadCarSize(carsale_category);
%>
                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__links">
                            ...
                            <span>Car Listing_<%=sbean.getName() %></span>
                        </div>
                    </div>
                </div>
            </div>
...
<%
	...
	ArrayList<CarListBean> al = dao.getCategoryCarList(carsale_category);
